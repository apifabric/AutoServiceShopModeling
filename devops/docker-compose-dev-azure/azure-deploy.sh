...
resourcename="autoserviceshopmodeling"  # lower case, only
resourcegroup="autoserviceshopmodeling_rg"
...
# git clone https://github.com/apilogicserver/autoserviceshopmodeling.git
# cd autoserviceshopmodeling
...
az group create --name autoserviceshopmodeling_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group autoserviceshopmodeling_rg --sku S1 --is-linux
az container create --resource-group autoserviceshopmodeling_rg --name autoserviceshopmodeling --image apilogicserver/autoserviceshopmodeling:latest --dns-name-label autoserviceshopmodeling --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//autoserviceshopmodeling.westus.azurecontainer.io:5656'
